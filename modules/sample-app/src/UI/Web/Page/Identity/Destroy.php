...
use Amazium\SampleApp\Application\Command\Identity\AbandonIdentity;
...
class Destroy extends AbstractPage
{
    ...
    public function __invoke(ServerRequestInterface $request, RequestHandlerInterface $handler)
    {
        ...
        $this->execute(AbandonIdentity::fromArray([ 'identity_id' => $identityId ]));
        return new RedirectResponse(
            sprintf(
                '/identity?msg=%s',
                urlencode('Identity successfully deleted')
            )
        );
    }
}
