...
use Amazium\SampleApp\Application\Command\BankAccount\AbandonBankAccount;
...
class Destroy extends AbstractPage
{
    ...
    public function __invoke(ServerRequestInterface $request, RequestHandlerInterface $handler)
    {
        ...
        $this->execute(AbandonBankAccount::fromArray([ 'bank_account_id' => $bankAccountId ]));
        return new RedirectResponse(
            sprintf(
                '/bank-account?msg=%s',
                urlencode('BankAccount successfully deleted')
            )
        );
    }
}
