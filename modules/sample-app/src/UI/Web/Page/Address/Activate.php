...
use Amazium\SampleApp\Application\Command\Address\ActivateAddress;
...
class Activate extends AbstractPage
{
    ...
    public function __invoke(ServerRequestInterface $request, RequestHandlerInterface $handler)
    {
        ...
        $this->execute(ActivateAddress::fromArray([ 'address_id' => $addressId ]));
        return new RedirectResponse(
            sprintf(
                '/address?msg=%s',
                urlencode('Address successfully activated')
            )
        );
    }
}
